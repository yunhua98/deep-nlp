...
fmod_struct = open(os.path.join("./data", "fast_pos_model.json"), "wb")
fmod_struct.write(model_struct.encode())
fmod_struct.close()

# train model
checkpoint = ModelCheckpoint(os.path.join("./data", "checkpoints_fast",
    "pos_weights.{epoch:02d}-{val_loss:.2f}.hdf5"), 
