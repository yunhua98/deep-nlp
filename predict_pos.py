...
model.load_weights(os.path.join("./ner/checkpoints_split", "ner_weights.45-0.17.hdf5"))
...
with open("./results/predictions/ner_test_split_predictions_5gram.csv", "w") as file:
