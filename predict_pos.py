...
# deserialize model
fmods = open(os.path.join("./data", "fast_pos_model.json"), "rb")
...
model.load_weights(os.path.join("./data/checkpoints_fast", "pos_weights.50-0.42.hdf5"))
...
with open("./results/predictions/fast_pos_train_augmented_predictions_5gram.csv", "w") as file:
