...
model.load_weights(os.path.join("./data/checkpoints_shuffled", "shuffled_pos_weights.07-2.62.hdf5"))
...
with open("./results/predictions/shuffled_predictions_5gram.csv", "w") as file:
